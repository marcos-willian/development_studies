...
gaussiana1 = criaGaussianaClassificada(c(2,2), 200, 0.8, 1)
gaussiana2 = criaGaussianaClassificada(c(4,4), 200, 0.4, -1)
...
#Treino
gaussianaTreino$gaussiana = rbind(gaussiana1$gaussiana[sampleTreino1,], gaussiana2$gaussiana[sampleTreino2,])
gaussianaTreino$classe = as.factor(cbind(gaussiana1$classe[sampleTreino1], gaussiana2$classe[sampleTreino2]))

#Teste
gaussianaTeste$gaussiana = rbind(gaussiana1$gaussiana[!sampleTreino1,], gaussiana2$gaussiana[!sampleTreino2,])
gaussianaTeste$classe = as.factor(cbind(gaussiana1$classe[!sampleTreino1], gaussiana2$classe[!sampleTreino2]))

#Plota dados de treinamento
png("IMG/P1_treinamento.png")
